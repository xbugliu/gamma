...
struct GammaHNSWIndex : GammaFLATIndex, faiss::IndexHNSW {
  GammaHNSWIndex(faiss::Index *quantizer, size_t d,
                 DistanceMetricType metric_type, int M, int efSearch,
                 int efConstruction, const char *docids_bitmap,
  ...
  int Search(VectorQuery &query, GammaSearchCondition *condition,
...
struct GammaHNSWFlatIndex : GammaHNSWIndex {
  GammaHNSWFlatIndex(size_t d, DistanceMetricType metric_type, int nlinks,
