...
void TableIO::WriteFieldInfos(Table &table) {
...
void TableIO::WriteVectorInfos(Table &table) {
...
void TableIO::WriteRetrievalType(Table &table) {
  FWriteByteArray(fio, table.RetrievalType());
}

void TableIO::WriteRetrievalParam(Table &table) {
  FWriteByteArray(fio, table.RetrievalParam());
}

int TableIO::Read(std::string &name, Table &table) {
...
void TableIO::ReadFieldInfos(Table &table) {
  int fields_num = 0;
...
void TableIO::ReadVectorInfos(Table &table) {
  int vectors_num = 0;
...
void TableIO::ReadRetrievalType(Table &table) {
  FReadByteArray(fio, table.RetrievalType());
}

void TableIO::ReadRetrievalParam(Table &table) {
